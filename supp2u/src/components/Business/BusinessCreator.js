...
function BusinessCreator(props) {
	...
	const submit = e => {
		...
		if (businessInformation.street === undefined) {
			console.log('Address in Required');
		} else {
			...
			Axios.get(
				`https://maps.googleapis.com/maps/api/geocode/json?address=${
					newAddressArray[0]
				}${newAddressArray[1]}${newAddressArray[2]},${
			...
			<div className="form">
				<form onSubmit={submit}>
					<div className="input-box-type1">
						<label>
							Name of business <span className="required-span">*</span>
						</label>
						<input
							type="text"
							name="name"
					...
					<div className="input-box-type1">
						<label>
							Address <span className="required-span">*</span>
						</label>
						<input
							type="text"
							name="street"
					...
					<div className="input-box-type1">
						<label>
							zipcode<span className="required-span">*</span>
						</label>
						<input
							placeholder="zipcode..."
							type="integer"
